...
const int Num_LOAD_RS = 3; // REVISION FOR LOAD
...
const int MultOp = 2;
const int DivOp = 3;
const int LoadOp = 4; // REVISION FOR LOAD
...
const int LOAD_Lat = 1; // REVISION FOR LOAD
const int ADD_Lat = 2;
...
int main()
{
    ...
    // const int Num_MULT_RS = 2;
    // const int Num_DIV_RS = 3;
    ReservationStation // REVISION FOR LOAD
